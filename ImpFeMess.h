 ...
 *
 * definitions for Imperium<->FE communication
 *
 * $Id: ImpFeMess.h,v 1.1.1.1 2000/05/17 19:22:13 marisa Exp $
 *
 * $Log: ImpFeMess.h,v $
 * Revision 1.1.1.1  2000/05/17 19:22:13  marisa
 * First CVS checkin
 *
 * Revision 1.1.1.3  1997/05/03 09:42:49  marisag
 * patch1: Daily checkin
 *
 * Revision 1.1.1.2  1997/04/17 09:26:37  marisag
 * patch1: Added support for lines 1 & 2 of planet production report
 *
 * Revision 1.1.1.1  1997/04/12 16:52:22  marisag
 * patch1: Changes to some keywords, several new additions.
 *
 * Revision 1.1  1997/04/09 03:43:18  marisag
 * Initial revision
 *
 *
 */
...
#define FE_WSIZE    "!*W"       /* A info world size line follows   */
